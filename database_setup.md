...
### **2. Tables**
- **Users**: Stores user information, including admins, managers, and regular users.
- **Categories**: Stores product categories.
- **Products**: Manages all product-related details, including price and quantity.
- **Requests**: Tracks user product requests.
- **Stock Movements**: Records product movement in the inventory.
- **Replenishments**: Logs stock replenishments.
